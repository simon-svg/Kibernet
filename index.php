...
<header class="container-fluid">
    <nav class="navbar navbar-expand-xl navbar-light">
        <a href="index.php" class="navbar-brand"><img src="/img/logo.png" id='logo' alt="logo"></a>
        <button type="button" class="navbar-toggler" data-toggle="collapse" data-target="#navbarCollapse">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse justify-content-end" id="navbarCollapse">
            <div class="navbar-nav">
                <a href="index.php" class="nav-item nav-link link-slide active">Գլխավոր</a>
                ...
                <a href="#a" class="nav-item nav-link link-slide"><i class="fa-solid fa-phone" id="phone-icon"></i> 093
                    | 095 028004</a>
...
<article id='tabs'>
    ...
    <div class="art_item art_item_home hover-yellow" id="home">
        <a href="#a">
            <h3>ՍՏԱՆԴԱՐՏ</h3>
            <span>4000֏</span>
            <p>30մբ/վ</p>
    ...
    <div class="art_item art_item_home hover-blue">
        <a href="#a">
            <h3>ՍՏԱՆԴԱՐՏ</h3>
            <span>5000֏</span>
            <p>60մբ/վ</p>
    ...
    <div class="art_item art_item_home hover-red">
        <a href="#a">
            <h3>ՍՏԱՆԴԱՐՏ+</h3>
            <span>6000֏</span>
            <p>80մբ/վ</p>
    ...
    <div class="art_item art_item_home hover-dark-blue">
        <a href="#a">
            <h3>ՄԵԳԱ</h3>
            <span>7000֏</span>
            <p>100մբ/վ</p>
    ...
    <div id="business_info">
        <h3>ԲԻԶՆԵՍԻ ՀԱՄԱՐ</h3>
        <p>
            Բիզնեսի համար ընկերությունը տրամադրում է փաթեթներ պայմանագրային հիմունքներով։ Պայմաններին մանրամասն
            ծանոթանալու համար կարող եք զանգահարել հետևյալ հեռախոսահամարներով։ <br> 093 | 095 028004
        </p>
    </div>
    <div id="gift_info">
